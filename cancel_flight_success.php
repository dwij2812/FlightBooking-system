...
if (isset($_POST['cancel'])){
    ...
    {
        echo '<script type="text/javascript">alert("Flight Successfully Removed");(window.location = "home.php");</script>';	
    }
}
?>
<html>
...
<body background="airplane.jpg">
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        ...
        <br><br><br>
        <div class="mdl-typography--title">Flight Has been Removed successfully from the Servers</div>
        </div>
